...
Foreach ($Name in $NameArray){
    ...
    New-ADGroup -Name "tg_RDS_$Name" -Path "OU=RDS,OU=Domain Groups,DC=,DC=de" -GroupScope Global -GroupCategory Security -Description "Berechtigung für RDS-Anwendung $Name"
